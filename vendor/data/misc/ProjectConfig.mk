...
CUSTOM_HAL_IMGSENSOR = imx682_mipi_raw s5kgw1_mipi_raw s5kgm1sp_mipi_raw imx471_mipi_raw s5k3p9sp_mipi_raw ov8856_mipi_raw ov02b10_mipi_raw ov02b1b_mipi_mono gc2375h_mipi_raw gc02m0_mipi_mono ov02a10_mipi_raw gc02k0_mipi_raw 
CUSTOM_HAL_LENS = bu64253af fp5516af dummy_lens
CUSTOM_HAL_MAIN3_IMGSENSOR = ov02b1b_mipi_mono gc02m0_mipi_mono ov02a10_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = ov8856_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_HAL_MAIN_IMGSENSOR = imx682_mipi_raw s5kgw1_mipi_raw s5kgm1sp_mipi_raw
CUSTOM_HAL_MAIN_LENS = bu64253af fp5516af dummy_lens
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB2_IMGSENSOR = ov02b10_mipi_raw gc2375h_mipi_raw gc02k0_mipi_raw
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = imx471_mipi_raw s5k3p9sp_mipi_raw
...
#ifdef ODM_HQ_EDIT
# zuoqiquan@ODM.BSP.Sensor  2019/08/29 bring up sensor
CUSTOM_KERNEL_BAROMETER = no
#endif /*ODM_HQ_EDIT*/
#ifdef ODM_HQ_EDIT
#Longyajun@ODM.HQ.Multimedia.LCM 2019/12/02 modified for sun screen
MTK_AAL_SUPPORT = yes
...
CUSTOM_KERNEL_IMGSENSOR = imx682_mipi_raw s5kgw1_mipi_raw s5kgm1sp_mipi_raw imx471_mipi_raw s5k3p9sp_mipi_raw ov8856_mipi_raw ov02b10_mipi_raw ov02b1b_mipi_mono gc2375h_mipi_raw gc02m0_mipi_mono ov02a10_mipi_raw gc02k0_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = bu64253af fp5516af dummy_lens
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN3_IMGSENSOR = ov02b1b_mipi_mono gc02m0_mipi_mono ov02a10_mipi_raw
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov8856_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx682_mipi_raw s5kgw1_mipi_raw s5kgm1sp_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = bu64253af fp5516af dummy_lens
...
CUSTOM_KERNEL_SOUND = mt6358
CUSTOM_KERNEL_STATIONARY_SENSOR = yes
CUSTOM_KERNEL_STEP_COUNTER = yes
CUSTOM_KERNEL_STEP_DETECTOR = no
CUSTOM_KERNEL_SUB2_IMGSENSOR = ov02b10_mipi_raw gc2375h_mipi_raw gc02k0_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = imx471_mipi_raw s5k3p9sp_mipi_raw
...
#ifdef ODM_HQ_EDIT
#shiguibiao@ODM_HQ.Network.Modem.no id, 2019/8/28,set Modem project config
CUSTOM_MODEM = oppo6785_ALL
#endif /*ODM_HQ_EDIT*/
...
#ifdef ODM_HQ_EDIT
#liyan@ODM.Multimedia.LCD ODM_HQ_EDIT 2019/08/27 modify from 2160 to 2400 for LCD bring up
LCM_HEIGHT = 2400
#else
#LCM_HEIGHT = 2160
#endif
...
#fanxiongnan@ODM.HQ.Multimedia.Audio 2019/08/15 modified for mic bringup
...
#fanxiongnan@ODM.HQ.Multimedia.Audio 2019/10/30 modified for closing adsp phone call algo.
...
MTK_BWC_SUPPORT = yes
#shiguibiao@ODM_HQ.Network.Modem.no id, 2019/10/30,set Modem FDD4M
MTK_C2K_LTE_MODE = 0
#endif /*ODM_HQ_EDIT*/
MTK_CAMERA_APP = no
...
MTK_DRM_APP = no
#ifdef ODM_HQ_EDIT
#Lu.Deyuan@ODM.MultiMedia 2019/12/04 Modify Widevine l1 for HQ.
...
##ifndef VENDOR_EDIT
#Qiujin.Pan@PSW.NW.SIM.1217573, 2018/01/15, Add for VSIM enable
#modify for Add for VSIM enable
...
MTK_FMRADIO_APP = yes
#ifdef VENDOR_EDIT
#Hefeng.Wu@RM.MM.AudioDriver.Machine, 2019/11/21, add for 50KHz space support
...
MTK_IPV6_VZW = no
#ifdef HQ_ODM_EDIT
# zuoqiquan@ODM.HQ.BSP.Sensor 2019/12/13 modified for RTC 2641011 have no IR sensor
...
#ifdef VENDOR_EDIT
#Yijiang.Jia@RM.AD.OppoLog.0, 2019/11/09. Modify for MT6785 to put the MTKLog to compile process for BUILD:user
...
#ifdef ODM_HQ_EDIT
# Longyajun@ODM.HQ.Multimedia.LCM 2019/12/27 modified for high quality visual effect
...
#ifdef VENDOR_EDIT
#Hefeng.Wu@RM.MM.AudioDriver.Feature, 2019/11/13, modify for VOW
MTK_VOW_BARGE_IN_SUPPORT = yes
MTK_VOW_COMMAND = keyword03
MTK_VOW_SUPPORT = yes
MTK_VOW_2E2K_SUPPORT = yes
MSSI_MTK_VOW_SUPPORT = yes
MSSI_MTK_VOW_2E2K_SUPPORT = yes
#endf /* VENDOR_EDIT */
...
#ifdef VENDOR_EDIT
#ZhenKun.Huang@RM.AD.AMS.2524040, 2019/11/27. Modify for game space service not bind
...
#ifdef VENDOR_EDIT
#Zeke.Shi@RM.MM.LCD.Stability, 2019/12/05, add for MTK OSIE feature .
MTK_VIDEO_ENHANCEMENT = yes
MTK_VIDEO_TRANSITION = yes
MTK_PQ_VIDEO_WHITELIST_SUPPORT = yes
#endif /* VENDOR_EDIT */
#ifdef ODM_HQ_EDIT
#guohuiqing@ODM.BSP.BuildConfig 2019/08/14 add ODM_HQ_EDIT Macro for HQ.
ODM_HQ_EDIT=yes
#endif #ODM_HQ_EDIT
#Bin.Li@BSP.Fingerprint.Basic, 2019/01/25, add for Widevine_L1 enable.
MTK_SEC_VIDEO_PATH_SUPPORT = yes
MTK_WVDRM_SUPPORT = yes
MTK_WVDRM_L1_SUPPORT = yes
MTK_DRM_KEY_MNG_SUPPORT = yes
...
# longyajun@ODM.Multimedia.BuildConfig 2020/08/10 add Macro for HQ begin.
PROJECT_20682_IGNORE_ICC = yes
# longyajun@ODM.Multimedia.BuildConfig 2020/08/10 add Macro for HQ end.
