...
function copy_mtklog() {
    ...
    mkdir -p sdcard/mtklog/fingerprint/egis
    ...
    mv /data/vendor/egis/* sdcard/mtklog/fingerprint/egis
    #mv faceunlock logs
    ...
    engineerFile="/sdcard/engineermode/"
    if [ -d "$engineerFile" ]; then
       mkdir -p sdcard/mtklog/engineermode
       #ifdef ODM_HQ_EDIT
       #Donghua.Gan@ODM_HQ.OppoEngineerMode, 2020/06/23, Update AgingTest show result.
       if [ ! `getprop ro.factory_version` ]; then
           #ifdef ODM_HQ_EDIT
           #Donghua.Gan@ODM_HQ.OppoEngineerMode, 2020/07/13, Update AgingTest show result.
             cp -rf /sdcard/engineermode/* /sdcard/mtklog/engineermode
           #else
             #mv -rf /sdcard/engineermode/* /sdcard/mtklog/engineermode
           #ENDIF /* ODM_HQ_EDIT */
       else
           #Donghua.Gan@ODM_HQ.OppoEngineerMode, 2020/06/30, ATO version use. Read log cp in engineermode.
           cp -rf /sdcard/engineermode/* /sdcard/mtklog/engineermode
           mkdir -p sdcard/mtklog/engineermode/opporeserve/criticalLog
           cp -rf /mnt/vendor/opporeserve/media/log/criticalLog/persist/ /sdcard/mtklog/engineermode/opporeserve/criticalLog
           mkdir -p sdcard/mtklog/engineermode/cache
           cp -rf /cache/factory/ /sdcard/mtklog/engineermode/cache
       fi
       #ENDIF /* ODM_HQ_EDIT */
    fi
